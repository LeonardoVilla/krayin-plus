...
class QuoteController extends Controller
{
    ...
    /**
     * Convert a quote (Cotação) into an invoice (Fatura). Reuses the same
     * record/structure — just flips the document_type flag.
     */
    public function convertToInvoice(int $id): JsonResponse
    {
        ...
        return response()->json([
            'message' => trans('admin::app.quotes.index.convert-to-invoice-success'),
        ]);
    }
