...
return [
    ...
    'projects' => [
        'index' => [
            'title' => 'Projetos',
            'create-btn' => 'Adicionar Projeto',
            'create-success' => 'Projeto adicionado com sucesso.',
            'update-success' => 'Projeto atualizado com sucesso.',
            'delete-success' => 'Projeto excluído com sucesso.',
            'delete-failed' => 'Não é possível excluir o projeto.',
            'datagrid' => [
                'name' => 'Nome',
                'status' => 'Status',
                'lead' => 'Oportunidade',
        ...
        'tasks' => [
            'title' => 'Tarefas',
            'create-btn' => 'Adicionar Tarefa',
            'create-success' => 'Tarefa adicionada com sucesso.',
            'update-success' => 'Tarefa atualizada com sucesso.',
            'delete-success' => 'Tarefa excluída com sucesso.',
            'delete-failed' => 'Não é possível excluir a tarefa.',
            'empty' => 'Nenhuma tarefa cadastrada ainda.',
            'edit-link' => 'Editar',
            'datagrid' => [
                'title' => 'Título',
                'status' => 'Status',
    ...
    'support-tickets' => [
        'index' => [
            'title' => 'Chamados',
            'create-btn' => 'Adicionar Chamado',
            'create-success' => 'Chamado adicionado com sucesso.',
            'update-success' => 'Chamado atualizado com sucesso.',
            'delete-success' => 'Chamado excluído com sucesso.',
            'delete-failed' => 'Não é possível excluir o chamado.',
            'datagrid' => [
                'subject' => 'Assunto',
                'status' => 'Status',
                'priority' => 'Prioridade',
    ...
    'quotes' => [
        'index' => [
            ...
            'convert-to-invoice-success' => 'Convertido em fatura com sucesso.',
            'datagrid' => [
                'subject' => 'Assunto',
