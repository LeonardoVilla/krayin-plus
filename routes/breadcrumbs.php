...
Breadcrumbs::for('support_tickets', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.layouts.support-tickets'), route('admin.support_tickets.index'));
});

// Dashboard > Support Tickets > Create
Breadcrumbs::for('support_tickets.create', function (BreadcrumbTrail $trail) {
    $trail->parent('support_tickets');
    $trail->push(trans('admin::app.support-tickets.create.title'), route('admin.support_tickets.create'));
});

// Dashboard > Support Tickets > Edit
Breadcrumbs::for('support_tickets.edit', function (BreadcrumbTrail $trail) {
    $trail->parent('support_tickets');
    $trail->push(trans('admin::app.support-tickets.edit.title'), url()->current());
});

// Dashboard > Projects
Breadcrumbs::for('projects', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.layouts.projects'), route('admin.projects.index'));
});

// Dashboard > Projects > Create
Breadcrumbs::for('projects.create', function (BreadcrumbTrail $trail) {
    $trail->parent('projects');
    $trail->push(trans('admin::app.projects.create.title'), route('admin.projects.create'));
});

// Dashboard > Projects > Edit
Breadcrumbs::for('projects.edit', function (BreadcrumbTrail $trail) {
    $trail->parent('projects');
    $trail->push(trans('admin::app.projects.edit.title'), url()->current());
});
